...
def cvt_csv2xml(cur_dir):
    ...
    csv_file = os.path.join(cur_dir, 'training_data', 'annotation', 'via_region_data (27).csv')
    ...
    for i, row in enumerate(csv_data):
        ...
        if row[5] != "{}":
            ...
            obj_description = "butt"

            if obj_description not in OBJ_LBLs:

                if obj_description.find('salmon') != -1:
                    obj_description = 'salmon'
            ...
            png_img_path = os.path.join(png_img_dir, img_filename)
