...
def main(_):
    ...
    FLAGS.pipeline_config_path = '/media/server/Test/training_model/faster_rcnn_resnet50.config'
    FLAGS.trained_checkpoint_prefix = '/media/server/Test/training_model/log/model.ckpt-109477'
    FLAGS.output_directory = '/media/server/Test/training_model/output_inference_graph'
